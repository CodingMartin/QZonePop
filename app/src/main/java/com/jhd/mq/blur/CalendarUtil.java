...
public class CalendarUtil {
    ...
    public static ChineseDrawable getNLDayOfDrawable(Context context) {
        Calendar calendar = Calendar.getInstance();
        int[] s = solarToLunar(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH)+1, calendar.get(Calendar.DAY_OF_MONTH));
        return getLunarDrawableNameOfDay(context, s[2]);
    }


    public static ChineseDrawable getLunarDrawableNameOfDay(Context context, int day) {
        if (day > 0 && day < 31) {
            switch (day) {
                case 1:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avi);
                case 2:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avp);
                case 3:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avn);
                case 4:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avf);
                case 5:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.ave);
                case 6:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avk);
                case 7:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avj);
                case 8:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avc);
                case 9:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avh);
                case 10:
                    return new ChineseDrawable(context, R.mipmap.avd, R.mipmap.avm);
                case 11:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avi);
                case 12:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avp);
                case 13:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avn);
                case 14:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avf);
                case 15:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.ave);
                case 16:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avk);
                case 17:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avj);
                case 18:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avc);
                case 19:
                    return new ChineseDrawable(context, R.mipmap.avm, R.mipmap.avh);
                case 20:
                    return new ChineseDrawable(context, R.mipmap.avp, R.mipmap.avm);
                case 21:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avi);
                case 22:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avp);
                case 23:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avn);
                case 24:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avf);
                case 25:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.ave);
                case 26:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avk);
                case 27:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avj);
                case 28:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avc);
                case 29:
                    return new ChineseDrawable(context, R.mipmap.avo, R.mipmap.avh);
                case 30:
                    return new ChineseDrawable(context, R.mipmap.avn, R.mipmap.avm);
            }
        }
        throw new IllegalArgumentException("mus be 1-30");
    }
